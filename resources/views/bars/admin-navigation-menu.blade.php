<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link href="{{ route('admin.reports.flagged') }}" :active="request()->routeIs('admin.reports.flagged')">
                        {{ __('Report Review') }}
                    </x-nav-link>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link href="{{ route('admin.user-roles') }}" :active="request()->routeIs('admin.user-roles')">
                        {{ __('User Roles') }}
                    </x-nav-link>
                </div>

                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link href="{{ route('admin.schema-management') }}" :active="request()->routeIs('admin.schema-management')">
                        {{ __('Schema Management') }}
                    </x-nav-link>
                </div>
            </div>
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        ...
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link href="{{ route('admin.user-roles') }}" :active="request()->routeIs('admin.user-roles')">
                {{ __('User Roles') }}
            </x-responsive-nav-link>
        </div>
